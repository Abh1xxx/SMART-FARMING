...
urlpatterns = [
    ...
    path('adproducts',views.adproducts,name='adproducts'),
    path('viewcustomerprofile',views.viewcustomerprofile,name='viewcustomerprofile'),
    path('sellernew',views.sellernew,name='sellernew'),
    path('vproo',views.vproo,name='vproo'),
    ...
    path('purchase1/addpayment1',views.addpayment1, name='addpayment1'),
    ...
    path('sellerpurchase/addpayment2',views.addpayment2,name='addpayment2'),
    path('purchase1/<int:id>',views.purchase1,name='purchase1'),
